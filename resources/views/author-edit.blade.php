<x-layout>
    ...
    @endif
    <form class="max-w-sm mx-auto" action="/author/update/{{ $authors->id }}" method="POST">
        @csrf
        @method('put')
        <div class="mb-5">
            <label for="name" class="block mb-2 text-md font-medium text-white dark:text-gray-900">Nama
                Penulis</label>
        ...
        <div class="mb-5">
            <label for="email" class="block mb-2 text-md font-medium text-white dark:text-gray-900">Your
                Email</label>
